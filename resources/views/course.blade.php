...
<div class="flex mt-4 mx-2 gap-4">
    <a class="card w-96 bg-base-100 shadow-xl card-bordered border-slate-400 hover:bg-neutral-100 transition" href="/course/{{$course->id}}">
        <div class="card-body">
        ...
        <div class="card-actions justify-start pb-6 ps-4">
            @if ($course->price == 0)
