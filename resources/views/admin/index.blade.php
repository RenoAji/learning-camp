...
@section('body')
    @parent
    <h2 class="text-xl font-semibold mb-1 ml-1">Course List:</h2>
          ...
          <tbody>
            @foreach ($courses as $i=>$course)
                <tr>
                    ...
                    <td>{{$course->name}}</td>
                    <td>
                      <div class="flex content-center gap-x-1">
                        <div class="tooltip" data-tip="View Detail">
                          <a href="/admin-dashboard/{{$course->id}}" class="btn btn-info">
                        ...
                        <div class="tooltip" data-tip="Delete Course">
                          <form method="POST" action="admin-dashboard/{{$course->id}}">
                            @csrf
                            @method('delete')
